...
class FetchFeed:
    ...
    def fetch(self):
        ...
        if not self.fpf:
            ...
            except (TypeError, ValueError, KeyError, EOFError, http.client.IncompleteRead, 
                    MemoryError, urllib.error.URLError, http.client.InvalidURL, ConnectionResetError) as e:
