...
Android recordings were captured on the existing Samsung Galaxy S22, running NewsBlur 15.0.4, on September 23, 2026. The four clips show story-list scrolling and reader navigation, image opening/zoom/dismissal, Quick Add opening and discovery navigation, and opening a discovery story and returning to the highlighted preview. The MP4 files use H.264 at 720 × 1560, 60 fps, without audio, at the original interaction speed. Still posters are fallbacks; animations are real screen recordings.

The existing iOS still captures were shared from the September 22 iPhone 17e simulator audit. They show the story list, article reader, and Add Site sheet. They are presented inside the iPhone 17 frame. New iOS motion captures await coordination of the shared simulator.

The player only starts clips when visible, pauses offscreen, honors reduced motion, and provides a keyboard-accessible play/pause button. Without JavaScript, native video controls remain available.
