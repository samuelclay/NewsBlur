...
At the top, you can summarize the story in three flavors: a single sentence, bullet points, or a full paragraph. Below that are presets I use most often:
...
- **Claude 4.5 Haiku** — Fast and lightweight
- **Claude 4.5 Sonnet** — Good balance of speed and capability
- **Claude 4.5 Opus** — The default, most capable model
