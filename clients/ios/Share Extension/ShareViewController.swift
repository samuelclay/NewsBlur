...
class ShareViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let foldersArray = prefs.object(forKey: "share:folders") as? [String] {
            ...
            folders.removeAll { ["river_global", "river_blurblogs", "trending:well_read", "trending:long_reads", "dashboard", "infrequent", "widget_stories", "read_stories", "saved_searches", "saved_stories"].contains($0) }
        }
