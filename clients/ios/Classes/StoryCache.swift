...
//        }
    ...
    // MARK: - Regex Input State
    // Stored here so it survives TrainerView reconstruction (TrainerViewController
    // replaces hostingController.rootView on reload/viewWillAppear).
    var titleIsRegex = false
    var titlePattern = ""
