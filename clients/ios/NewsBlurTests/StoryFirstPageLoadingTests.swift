...
@MainActor final class Test_StoryFirstPageLoading: XCTestCase {
    ...
    func test_localReadAndSaveWhileFlushingSurviveOlderServerResponse() async throws {
        ...
        fixture.open()
        await settle()
        let story = try XCTUnwrap(fixture.stories.activeFeedStories.first as? [AnyHashable: Any])
        fixture.stories.markStoryRead(story, feed: nil)
        let readStory = try XCTUnwrap(fixture.stories.activeFeedStories.first as? [AnyHashable: Any])
        ...
        await settle()
        let refreshed = try XCTUnwrap(fixture.stories.activeFeedStories.first as? [String: Any])
    ...
    func test_localUnreadAndUnsavePreserveReversalAndRemovedDate() async throws {
        ...
        let unreadStory = try XCTUnwrap(fixture.stories.activeFeedStories.first as? [AnyHashable: Any])
    ...
    func test_provisionalReadStateDoesNotTrustUnownedGlobalReadTables() async throws {
        ...
        fixture.open()
        await settle()
        let first = try XCTUnwrap(fixture.stories.activeFeedStories.first as? [AnyHashable: Any])
        let second = try XCTUnwrap(fixture.stories.activeFeedStories.dropFirst().first as? [AnyHashable: Any])
