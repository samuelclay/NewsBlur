...
class Test_StoryImageSource {
    ...
    @Test fun test_only_image_data_and_web_urls_can_be_loaded() {
        ...
        listOf("file:///data/data/com.newsblur/shared_prefs/preferences.xml", "content://private/image", "javascript:alert(1)",
            "data:text/html,<h1>bad</h1>", "https:///missing-host").forEach { assertFalse(StoryImageSource.isAllowedUrl(it)) }
    }
    ...
    @Test fun test_offline_cache_paths_are_confined_to_image_files() {
        ...
        listOf("$root/images/../preferences.xml", "$root/images/%2e%2e%2fpreferences.xml", "$root/assets/storyDetailView.js",
            "$root/images/../assets/a.jpg", "$root:123/images/a.jpg").forEach {
