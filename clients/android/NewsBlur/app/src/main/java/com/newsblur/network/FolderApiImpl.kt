...
class FolderApiImpl(
    ...
    override suspend fun deleteFolder(folderName: String?, inFolder: String): NewsBlurResponse {
        val values = ContentValues().apply {
    ...
    override suspend fun renameFolder(folderName: String?, newFolderName: String, inFolder: String): NewsBlurResponse {
        val values = ContentValues().apply {
    ...
    override suspend fun moveFeedToFolders(feedId: String?, toFolders: Set<String>, inFolders: Set<String>): NewsBlurResponse {
