...
class WidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(
        ...
        if (intent.action == WidgetUtils.ACTION_OPEN_STORY) {
            ...
            Intent(context, AllStoriesItemsList::class.java)
                .apply {
            ...
            Intent(context, WidgetConfig::class.java)
                .apply {
                    addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                }.also {
                    context.applicationContext.startActivity(it)
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            val touchIntentTemplate =
                getMutableBroadcast(
                    context,
                    WidgetUtils.RC_WIDGET_STORY,
                    touchIntent,
