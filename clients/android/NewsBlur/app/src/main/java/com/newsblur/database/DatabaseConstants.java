...
public class DatabaseConstants {
    ...
    public static final String STORY_INTELLIGENCE_TEXT = "intelligence_text";
    ...
    static final String STORY_SQL = "CREATE TABLE " + STORY_TABLE + " (" +
            ...
            STORY_INTELLIGENCE_TEXT + INTEGER + ", " +
    ...
    private static final String[] BASE_STORY_COLUMNS = {
            ...
            STORY_INTELLIGENCE_TITLE, STORY_INTELLIGENCE_TEXT, STORY_PERMALINK, STORY_READ, STORY_STARRED, STORY_STARRED_DATE, STORY_TAGS, STORY_HIGHLIGHTS, STORY_USER_TAGS, STORY_TITLE,
    ...
    public static List<String> unflattenStringList(String flat) {
        return JsonHelper.fromJson(flat, new TypeToken<List<String>>() {
        }.getType());
    }

    public static final String SYNC_METADATA_KEY_SESSION_FEED_SET = "session_feed_set";

    public static final String MIGRATE_V3_TO_V4_SQL =
            "ALTER TABLE " + DatabaseConstants.STORY_TABLE + " ADD COLUMN " + DatabaseConstants.STORY_INTELLIGENCE_TEXT + " INTEGER DEFAULT 0";
}
