...
public class FeedReadingAdapter extends ReadingAdapter {
	...
	public Fragment getItem(int position)  {
		if (stories == null || stories.getCount() == 0) {
			...
			return ReadingItemFragment.newInstance(Story.fromCursor(stories), feed.title, feed.faviconColour, feed.faviconFade, feed.faviconText, feed.faviconUrl, classifier, false);
		}
	}
