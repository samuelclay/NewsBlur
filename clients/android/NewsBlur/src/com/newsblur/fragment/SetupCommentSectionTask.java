		...
		for (final Comment comment : comments) {
			...
			if (comment.likingUsers != null) {
				...
				for (String id : comment.likingUsers) {
                    ...
                    if (user != null) {
                        FeedUtils.imageLoader.displayImage(user.photoUrl, favouriteImage, 10f, false);
			...
			for (Reply reply : replies) {
				...
				if (replyUser != null) {
					FeedUtils.imageLoader.displayImage(replyUser.photoUrl, replyImage, 5, false);
            ...
            if (!TextUtils.isEmpty(comment.sourceUserId)) {
				...
				if (sourceUser != null) {
					FeedUtils.imageLoader.displayImage(sourceUser.photoUrl, sourceUserImage, 10f, false);
					FeedUtils.imageLoader.displayImage(userPhoto, usershareImage, 10f, false);
				}
			} else {
				FeedUtils.imageLoader.displayImage(userPhoto, commentImage, 10f, false);
			}
