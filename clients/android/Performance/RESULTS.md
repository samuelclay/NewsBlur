...
**Progress report:** the latest build passes 330 tests. Rapid folder toggles and prepared Next/Previous navigation pass in all four themes. Rapid navigation, Home/resume, and Back during far-page preparation also pass. Corrected navigation timing is recorded below as an unpaired observation; a proper long-article scrolling comparison remains pending. The feed/title timing captures precede the latest animation/navigation fixes; this report does not mark the audit complete.
...
These Engadget pages are short articles. Their navigation and two scroll attempts do not establish scrolling performance through a long article body. A matching long-body baseline/after scenario remains pending.
