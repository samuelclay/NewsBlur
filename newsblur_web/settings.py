...
MONGOANALYTICSDB = connect(f"mongodb://{MONGO_ANALYTICS_DB['username']}:{MONGO_ANALYTICS_DB['password']}@{MONGO_ANALYTICS_DB['host']}/nbanalytics?authSource=admin", alias="nbanalytics")
