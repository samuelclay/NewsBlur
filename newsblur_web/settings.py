...
MONGOANALYTICSDB = connect(f"mongodb://{MONGO_ANALYTICS_DB['username']}:{MONGO_ANALYTICS_DB['password']}@{MONGO_ANALYTICS_DB['host']}:{MONGO_PORT}/?authSource=admin", alias="nbanalytics")
