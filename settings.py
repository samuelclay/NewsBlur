...
PRODUCTION = __file__.find('/home/conesus/protopub') == 0
DEV_SERVER1 = __file__.find('/Users/conesus/Projects/protopub') == 0
DEV_SERVER2 = __file__.find('/Users/conesus/protopub') == 0
...
COMPRESS_JS = {
    'all': {
        'source_filenames': (
            ...
            'js/protopub/assetmodel.js',
            'js/protopub/reader.js',
            'js/protopub/reader_classifier.js',
            'js/protopub/reader_add_feed.js',
            'js/protopub/reader_manage_feed.js',
        ),
...
AUTH_PROFILE_MODULE = 'protopub.UserProfile'
