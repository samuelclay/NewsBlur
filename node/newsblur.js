// NewsBlur Node.js entry point -- Express server that mounts all sub-services
// (original_text, original_page, favicons) and the Socket.IO unread-counts server.
// Initializes Sentry for error tracking and serves health-check endpoints.
