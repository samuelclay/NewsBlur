// Favicon server -- serves cached feed favicons from MongoDB. Looks up favicon
// data by feed_id, returns the binary image with appropriate content-type headers,
// and falls back to a default icon for missing entries.
