// Original Page server -- stores and serves cached copies of original web pages.
// Handles GET (with ETag/If-None-Match caching) and POST (multipart upload) for
// feed story pages stored on disk at /srv/originals/<feed_id>/.
