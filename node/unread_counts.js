...
(function() {
  var archive_assistant, ask_ai, briefing, fs, global_search, log, redis, unread_counts, webfeed;
    ...
    io.on('connection', function(socket) {
      ...
      socket.on('subscribe:feeds', (feeds, username) => {
        ...
        return socket.subscribe.on('message', (channel, message) => {
          ...
          if (typeof message.startsWith === "function" ? message.startsWith('global_search:') : void 0) {
