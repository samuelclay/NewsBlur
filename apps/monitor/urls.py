...
urlpatterns = [
    ...
    url(r"^domain-fetch?$", DomainFetch.as_view(), name="domain_fetch"),
    ...
    url(r"^mcp-usage?$", MCPUsage.as_view(), name="mcp_usage"),
    ...
    url(r"^scrapingbee-usage?$", ScrapingBeeUsage.as_view(), name="scrapingbee_usage"),
