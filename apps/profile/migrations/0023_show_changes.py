...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.show_changes'
        db.add_column(u'profile_profile', 'show_changes',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.show_changes'
        db.delete_column(u'profile_profile', 'show_changes')
    ...
    models = {
        ...
        u'profile.profile': {
            ...
            'show_changes': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
