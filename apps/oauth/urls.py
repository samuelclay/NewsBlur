...
urlpatterns = patterns('',
    ...
    url(r'^triggers/(?P<trigger_slug>(new-unread-story|new-focus-story))/fields/feed_or_folder/options/?$', views.api_feed_list, name="ifttt-trigger-feedlist"),
    url(r'^triggers/(?P<unread_score>(new-unread-story|new-focus-story))/?$', views.api_unread_story, name="ifttt-trigger-unreadstory"),
    url(r'^triggers/new-saved-story/fields/story_tag/options/?$', views.api_saved_tag_list, name="ifttt-trigger-taglist"),
