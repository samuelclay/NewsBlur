...
# minutes and a client that spends the whole budget at once is told to retry in 301 to 360
# seconds, depending on how far into the minute it is. apps/reader/views.py
