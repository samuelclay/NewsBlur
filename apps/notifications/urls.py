...
urlpatterns = [
    ...
    re_path(r"^classifier/?$", views.set_classifier_notification, name="set-classifier-notification"),
    re_path(r"^classifiers/?$", views.get_classifier_notifications, name="get-classifier-notifications"),
