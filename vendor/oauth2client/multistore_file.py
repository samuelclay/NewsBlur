...
class _MultiStore(object):
    ...
    class _Storage(BaseStorage):
        ...
        def locked_delete(self):
            ...
            Args:
              credentials: Credentials, the credentials to store.
            """
            self._multistore._delete_credential(self._client_id, self._user_agent, self._scope)
    ...
    def _lock(self):
        ...
        if not self._file.is_locked():
            ...
            if self._warn_on_readonly:
                logger.warn(
                    "The credentials file (%s) is not writable. Opening in "
    ...
    def _refresh_data_cache(self):
        ...
        try:
            ...
            logger.warn(
                "Missing version for credential data store. It may be "
                "corrupt or an old version. Overwriting."
            )
        if version > 1:
            raise NewerCredentialStoreError(
                "Credential file has file_version of %d. " "Only file_version of 1 is supported." % version
            )
