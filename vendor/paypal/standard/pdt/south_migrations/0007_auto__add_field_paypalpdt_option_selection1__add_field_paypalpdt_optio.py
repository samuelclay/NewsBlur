...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayPalPDT.option_selection1'
        db.add_column(u'paypal_pdt', 'option_selection1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'PayPalPDT.option_selection2'
        db.add_column(u'paypal_pdt', 'option_selection2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayPalPDT.option_selection1'
        db.delete_column(u'paypal_pdt', 'option_selection1')

        # Deleting field 'PayPalPDT.option_selection2'
        db.delete_column(u'paypal_pdt', 'option_selection2')
