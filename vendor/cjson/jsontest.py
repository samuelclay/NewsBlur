...
"""
    ...
    def testUnicodeEncode(self):
        ...
        self.assertEqual(cjson.encode({'o"': "öőüű"}), r'{"o\"": "\u00f6\u0151\u00fc\u0171"}')
    ...
    def testUnicodeDecode(self):
        ...
        self.assertEqual(cjson.decode(r'{"o\"": "\u00f6\u0151\u00fc\u0171"}'), {'o"': "öőüű"})
        self.assertEqual(
            cjson.decode(r'{"o\"": "\u00f6\u0151\u00fc\u0171"}', encoding="latin2"), {'o"': "öőüű"}
        )
        self.assertEqual(cjson.decode(r'"\u00f6\u0151\u00fc\u0171"', all_unicode=True), "öőüű")
