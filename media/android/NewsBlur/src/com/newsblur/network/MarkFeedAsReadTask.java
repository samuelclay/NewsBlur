...
public class MarkFeedAsReadTask extends AsyncTask<String, Void, Boolean> {
	...
	private final SimpleCursorTreeAdapter adapter;
	private String feedId;

	public MarkFeedAsReadTask(final Context context, final APIManager apiManager, final ContentResolver resolver, final SimpleCursorTreeAdapter adapter) {
