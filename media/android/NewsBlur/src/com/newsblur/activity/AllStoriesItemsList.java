...
import com.newsblur.fragment.EverythingItemListFragment;
...
public class AllStoriesItemsList extends ItemsList {
	...
	protected void onCreate(Bundle bundle) {
		...
		itemListFragment = (EverythingItemListFragment) fragmentManager.findFragmentByTag(FeedItemListFragment.FRAGMENT_TAG);
		if (itemListFragment == null) {
			itemListFragment = EverythingItemListFragment.newInstance(currentState);
