    ...
    NEWSBLUR.Reader.prototype = {
        ...
        show_next_unread_story: function() {
            ...
            if (unread_count) {
                ...
                } else if (this.flags['find_next_unread_on_page_of_feed_stories_load'] < this.constants.FILL_OUT_PAGES) {
        ...
        load_feed_iframe: function(feed_id) {
            ...
            $feed_iframe.removeAttr('src').attr({src: '/reader/page?feed_id='+feed_id});
            ...
            $feed_iframe.ready(function() {
                ...
                if ($feed_iframe.attr('src').indexOf('/reader/page?feed_id='+feed_id) != -1) {
